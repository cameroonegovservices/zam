...
class TestParseFromCSV:
    def test_senateur(self, lecture_senat):
    ...
    def test_auteur_groupe(self, lecture_senat):
        ...
        amend = {
            ...
            "Au nom de ": "groupe socialiste et républicain",
            "Auteur ": "Mme GRELET-CERTENAIS",
            "Date de dépôt ": "2018-11-12",
            "Dispositif ": "<body><p>Supprimer cet article.</p></body>",
            "Fiche Sénateur": (
                "//www.senat.fr/senfic/grelet_certenais_nadine19727d.html"
            ),
            "Nature ": "Amt",
            "Numéro ": "380 rect.",
            "Objet ": (
                "<body><p>La mansu&#233;tude du gouvernement &#224; l'&#233;gard "
                "des fraudeurs volontaires au travail dissimul&#233; risque de "
                "banaliser cette fraude.</p></body>"
            ),
            "Sort ": "Recevable art. 40 C / LOLF",
            "Subdivision ": "Article 17",
            "Url amendement ": "//www.senat.fr/amendements/2018-2019/106/Amdt_380.html",
        }

        source = Senat()
        amendement, _ = source.parse_from_csv(amend, lecture_senat)

        assert amendement.auteur == "Mme GRELET-CERTENAIS"

    def test_auteur_commission(self, lecture_senat):
        ...
        amend = {
            ...
            "Fiche Sénateur": "//www.senat.fr/senfic/vanlerenberghe_jean_marie01034p.html",  # noqa
            "Nature ": "Amt",
            "Numéro ": "629",
